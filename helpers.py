...
def apology(message):
    # image source: http://www.essex1.com/people/paul/bible56.html
...
def lookup(symbol):
    ...
    try:
        ...
        url = Request('http://download.finance.yahoo.com/d/quotes.csv?f=snl1&s={symbol}', headers={'User-Agent': 'Mozilla/5.0'})
